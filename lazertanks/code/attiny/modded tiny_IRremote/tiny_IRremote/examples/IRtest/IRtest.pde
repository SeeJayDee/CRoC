/*
 * tiny_IRremote: IRtest unittest
 * Version 0.1 July, 2009
 * Copyright 2009 Ken Shirriff
 * http://arcfn.com
 *
 * Note: to run these tests, edit tiny_IRremote/tiny_IRremote.h to add "#define TEST"
 * You must then recompile the library by removing tiny_IRremote.o and restarting
 * the arduino IDE.
 */
